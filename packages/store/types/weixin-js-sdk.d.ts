declare namespace WeixinJsSdk {
  /** **************************************************************************
   * Type definations
   * https://segmentfault.com/a/1190000043624044
   * update at 2023-09-23, by yanqing
   ****************************************************************************/
  type JSApis =
  ...
  interface UpdateTimelineShareDataOptions extends MenuCallbacks {
    /**
     * 分享标题
     */
    title: string
  ...
  interface UpdateAppMessageShareDataOptions
    extends UpdateTimelineShareDataOptions {
    /**
     * 分享描述
     */
    desc?: string
  ...
  function updateTimelineShareData(
    options: UpdateTimelineShareDataOptions
  ): void
  ...
  function updateAppMessageShareData(
    options: UpdateAppMessageShareDataOptions
  ): void
